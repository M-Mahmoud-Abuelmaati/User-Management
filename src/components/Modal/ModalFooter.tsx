...
}> = ({ modalSettings, onHandleClearFields, onHandleSubmit }) => {
  return (
    <div className="flex justify-between items-center p-6 space-x-2 border-t border-gray-200 rounded-b">
      <h1 className="underline underline-offset-2 text-black font-semibold cursor-pointer" onClick={() => onHandleClearFields()}>
        Reset fields
      </h1>
